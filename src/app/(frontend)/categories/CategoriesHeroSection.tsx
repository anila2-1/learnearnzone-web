...
export default function CategoriesHeroSection() {
  return (
    ...
    >
      ...
      {/* HERO-LIKE CONTENT */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[500px] p-8 md:p-12 lg:p-16 text-center">
        <MotionDiv
        ...
        >
          ...
          >
            ...
            <motion.span
              className="inline-block text-pink-600 mx-1"
              variants={{
                hidden: { opacity: 0 },
                visible: { opacity: 1 },
              }}
            >
              <TypingText text="Explore" />
            </motion.span>
            ...
            >
              Discover topics that spark your curiosity and expand your knowledge.
            </motion.span>
          </motion.h2>
        </MotionDiv>
      </div>
