...
export default function LogoutButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-linear-to-r from-red-50 to-pink-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm"></span>
      ...
      {/* Slide-in Underline */}
      <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-linear-to-r from-red-500 to-pink-500 group-hover:w-full transition-all duration-300"></span>
    </motion.button>
  )
}
