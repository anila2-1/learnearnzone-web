...
export default async function BlogList({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-slate-50 via-white to-blue-50">
      <div className="relative px-6 py-16 sm:py-20 md:py-24 text-center">
        <h1 className="text-4xl p-2.5 sm:text-5xl md:text-6xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 tracking-tight">
          Learn & Earn Blog
        </h1>
